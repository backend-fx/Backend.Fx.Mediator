...
internal sealed class Mediator : IMediator
{
    ...
    public Mediator(IRootMediator rootMediator, IServiceProvider serviceProvider, MediatorOptions options,
        ...
        CancellationToken cancellation = default) where TResponse : class
    {
        TResponse response = await new RequestDispatch(_handlerRegistry, _serviceProvider)
            .DispatchAsync(request, _options.DefaultRequestor, cancellation)
